-- Generation Time: Jan 24, 2009 at 12:25 PM
...
-- 
-- Table structure for table `sqd_config`
-- 
...
-- 
-- Table structure for table `sqd_contentpages`
-- 

CREATE TABLE `sqd_contentpages` (
  `page_id` int(11) unsigned NOT NULL auto_increment,
  `page_alias` varchar(40) NOT NULL default '',
  `template_priority` bit(1) NOT NULL default 0x01,
  PRIMARY KEY  (`page_id`),
...
-- 
-- Table structure for table `sqd_contentpage_names`
-- 
...
-- 
-- Table structure for table `sqd_contentpage_name_templates`
-- 
...
-- 
-- Table structure for table `sqd_contentpage_templates`
-- 
...
-- 
-- Table structure for table `sqd_contentpage_visibility`
-- 

CREATE TABLE `sqd_contentpage_visibility` (
  `page_id` int(11) unsigned NOT NULL,
  `name_id` int(11) unsigned NOT NULL,
  `visibility` bit(1) NOT NULL default 0x01,
  PRIMARY KEY  (`page_id`,`name_id`),
  KEY `page_id` (`page_id`),
  KEY `name_id` (`name_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- 
-- Table structure for table `sqd_contents`
-- 
...
-- 
-- Table structure for table `sqd_content_local_paths`
-- 
...
-- 
-- Table structure for table `sqd_content_templates`
-- 
...
-- 
-- Table structure for table `sqd_forms`
-- 

CREATE TABLE `sqd_forms` (
  `form_id` int(11) unsigned NOT NULL auto_increment,
  `form_name` varchar(40) NOT NULL default '',
  `form_method` bit(1) NOT NULL default 0x01,
...
-- 
-- Table structure for table `sqd_form_fields`
-- 
...
-- 
-- Table structure for table `sqd_form_field_configs`
-- 
...
-- 
-- Table structure for table `sqd_form_field_css_classes`
-- 
...
-- 
-- Table structure for table `sqd_form_templates`
-- 
...
-- 
-- Table structure for table `sqd_modules`
-- 
...
CREATE TABLE `sqd_modules` (
  ...
  `module_installed` bit(1) NOT NULL default 0x01,
  `module_enabled` bit(1) NOT NULL default 0x01,
  `module_is_core` bit(1) NOT NULL default 0x00,
...
-- 
-- Table structure for table `sqd_module_dependencies`
-- 
...
-- 
-- Table structure for table `sqd_tables`
-- 
...
-- 
-- Table structure for table `sqd_table_templates`
-- 
...
-- 
-- Table structure for table `sqd_themes`
-- 
...
-- 
-- Stand-in structure for view `sqd_view_contentpages`
-- 
...
-- 
-- Stand-in structure for view `sqd_view_contentpage_names`
-- 
...
-- 
-- Stand-in structure for view `sqd_view_contents`
-- 
...
-- 
-- Stand-in structure for view `sqd_view_forms`
-- 
...
-- 
-- Stand-in structure for view `sqd_view_tables`
-- 
...
-- 
-- Constraints for table `sqd_config`
-- 
ALTER TABLE `sqd_config`
  ADD CONSTRAINT `sqd_config_fk` FOREIGN KEY (`theme`) REFERENCES `sqd_themes` (`theme_id`) ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_contentpage_name_templates`
-- 
ALTER TABLE `sqd_contentpage_name_templates`
  ADD CONSTRAINT `sqd_contentpage_name_templates_fk` FOREIGN KEY (`page_id`) REFERENCES `sqd_contentpages` (`page_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sqd_contentpage_name_templates_fk1` FOREIGN KEY (`name_id`) REFERENCES `sqd_contentpage_names` (`name_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sqd_contentpage_name_templates_fk2` FOREIGN KEY (`template_id`) REFERENCES `sqd_templates` (`template_id`) ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_contentpage_templates`
-- 
ALTER TABLE `sqd_contentpage_templates`
  ADD CONSTRAINT `sqd_contentpage_templates_fk` FOREIGN KEY (`page_id`) REFERENCES `sqd_contentpages` (`page_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sqd_contentpage_templates_fk1` FOREIGN KEY (`template_id`) REFERENCES `sqd_templates` (`template_id`) ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_contentpage_visibility`
-- 
ALTER TABLE `sqd_contentpage_visibility`
  ADD CONSTRAINT `sqd_contentpage_visibility_fk` FOREIGN KEY (`page_id`) REFERENCES `sqd_contentpages` (`page_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `sqd_contentpage_visibility_fk1` FOREIGN KEY (`name_id`) REFERENCES `sqd_contentpage_names` (`name_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_content_local_paths`
-- 
ALTER TABLE `sqd_content_local_paths`
  ADD CONSTRAINT `content_local_paths_fk` FOREIGN KEY (`content_id`) REFERENCES `sqd_contents` (`content_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_content_templates`
-- 
ALTER TABLE `sqd_content_templates`
  ADD CONSTRAINT `content_templates_fk` FOREIGN KEY (`content_id`) REFERENCES `sqd_contents` (`content_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `content_templates_fk1` FOREIGN KEY (`template_id`) REFERENCES `sqd_templates` (`template_id`) ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_form_fields`
-- 
ALTER TABLE `sqd_form_fields`
  ADD CONSTRAINT `sqd_form_fields_fk` FOREIGN KEY (`form_id`) REFERENCES `sqd_forms` (`form_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sqd_form_fields_fk1` FOREIGN KEY (`field_id`) REFERENCES `sqd_form_field_configs` (`field_id`) ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_form_field_css_classes`
-- 
ALTER TABLE `sqd_form_field_css_classes`
  ADD CONSTRAINT `sqd_form_field_css_classes_fk` FOREIGN KEY (`field_id`) REFERENCES `sqd_form_field_configs` (`field_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_form_templates`
-- 
ALTER TABLE `sqd_form_templates`
  ADD CONSTRAINT `sqd_form_templates_fk` FOREIGN KEY (`form_id`) REFERENCES `sqd_forms` (`form_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sqd_form_templates_fk1` FOREIGN KEY (`template_id`) REFERENCES `sqd_templates` (`template_id`) ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_module_dependencies`
-- 
ALTER TABLE `sqd_module_dependencies`
  ADD CONSTRAINT `sqd_module_dependencies_fk` FOREIGN KEY (`module_id`) REFERENCES `sqd_modules` (`module_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sqd_module_dependencies_fk1` FOREIGN KEY (`depending_module_id`) REFERENCES `sqd_modules` (`module_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- 
-- Constraints for table `sqd_table_templates`
-- 
ALTER TABLE `sqd_table_templates`
  ADD CONSTRAINT `sqd_table_templates_fk` FOREIGN KEY (`table_id`) REFERENCES `sqd_tables` (`table_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sqd_table_templates_fk1` FOREIGN KEY (`template_id`) REFERENCES `sqd_templates` (`template_id`) ON UPDATE CASCADE;
...
DELIMITER $$
-- 
CREATE PROCEDURE `sqd_addContent`(IN _alias VARCHAR(40), IN _type TINYINT(4), IN _path VARCHAR(50), IN _template TEXT, OUT _RETURNCODE TINYINT)
BEGIN
...
CREATE PROCEDURE `sqd_addNamedContentPage`(IN _alias VARCHAR(40), IN _name VARCHAR(40), IN _template TEXT, OUT _RETURNCODE TINYINT)
BEGIN
...
CREATE PROCEDURE `sqd_addTable`(IN _table_alias VARCHAR(40), IN _table_type TINYINT, IN _table_sql TEXT, IN _table_template TEXT, OUT _RETURNCODE TINYINT)
BEGIN
...
CREATE PROCEDURE `sqd_amendNamedContentPage`(IN _alias VARCHAR(40), IN _name VARCHAR(40), IN _template TEXT, OUT _RETURNCODE TINYINT)
BEGIN
...
CREATE PROCEDURE `sqd_checkContentPage`(IN _alias VARCHAR(40))
BEGIN
...
CREATE PROCEDURE `sqd_getContentPageTemplate`(IN page_alias VARCHAR(40), IN name VARCHAR(40))
BEGIN
  DECLARE done BOOLEAN DEFAULT FALSE;
...
CREATE PROCEDURE `sqd_getFormTemplate`(IN _form_name VARCHAR(40))
BEGIN
...
CREATE PROCEDURE `sqd_getSiteTheme`(IN site VARCHAR(10))
BEGIN
SELECT
	t.`theme_name`
